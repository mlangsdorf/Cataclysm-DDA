...
| expire      | A time string.  When the map is generated, the time string is added to the current turn and stored with in the monster as an expiration time.  Any time the map is loaded after the expiration time, the monster will not be loaded.
