void cm_opts::faction_camp_missions( npc &p )
{
    ...
    if( ( ( om_min_level( "faction_base_camp_4", om_cur ) && om_expansions.empty() ) ||
...
bool talk_function::camp_missions( npc &p, const std::string &id, const std::string &title, mission_entry &cur_key )
